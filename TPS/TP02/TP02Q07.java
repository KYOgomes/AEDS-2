 ...
 */
 ...
 public class TP02Q07 extends Personagem {
     ...
     public static void main(String[] args) throws Exception {
         ...
         ordenarPorDataDeNascimento(personagens, tampersonagens);
     ...
     public static void ordenarPorDataDeNascimento(Personagem[] array, int tamanho) {
        for (int i = 1; i < tamanho; i++) {
            Personagem chave = array[i];
            int j = i - 1;

            while (j >= 0 && compararDataDeNascimento(array[j], chave) > 0) {
                array[j + 1] = array[j];
                j = j - 1;
            }
            array[j + 1] = chave;
    ...
    // Método para comparar datas de nascimento de personagens
    public static int compararDataDeNascimento(Personagem p1, Personagem p2) {
        Date data1 = p1.getDateOfBirth();
        Date data2 = p2.getDateOfBirth();
     ...
     public static void criarArquivoLog() {
         ...
         ordenarPorDataDeNascimento(copiaPersonagens, tampersonagens);
