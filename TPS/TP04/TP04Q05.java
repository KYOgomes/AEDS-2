...
class HashTable
{
    ...
    public int qtdOverflow;
    public final int tamTab = 21;
    public final int tamOver = 9;
    
    HashTable()
    {
        array = new Character[tamTab + tamOver];
        qtdOverflow = 0;
    }
    ...
    public void insert(Character x) throws Exception
    {
        ...
        else if(qtdOverflow < tamOver)
        {
            array[tamTab + qtdOverflow++] = x;
        }
    ...
    public boolean pesquisar(String x, TP tp) throws Exception {
        ...
        if (array[pos] != null && array[pos].getName().equals(x)) {
            ...
            tp.addComp(1);
            for (int i = 0; i < qtdOverflow; i++) {
                tp.addComp(1);
                if (array[tamTab + i] != null && array[tamTab + i].getName().equals(x)) {
                    resp = true;
                    System.out.print("(Posicao: " + (tamTab + i) + ")");
                    break;
                }
            }
        }
